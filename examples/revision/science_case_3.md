...
Every claim in Section 2.3 is now tied to one or two explicit, rerunnable prompts.
...
**Purpose:** Establish one defensible ranking logic (frequency-weighted).

Identify the dominant chemical risk drivers in European rivers and lakes
based on cumulative contribution to mixture toxicity.

For each chemical:
- count how often it appears as a mixture toxicity driver,
- sum its driver importance across all site–time records.

Rank chemicals by summed driver importance and report the top 20.
